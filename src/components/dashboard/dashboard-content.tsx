        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Link href="/invoices/new">
              <Button variant="outline" className="w-full justify-start mb-3 cursor-pointer">
